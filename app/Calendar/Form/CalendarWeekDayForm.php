...
class CalendarWeekDayForm extends CalendarWeekDay
{
	...
	function render()
	{
		...
		$html[] = '<option value="'. Setting::A_season .'" '. $isSelectA .'>Aシーズン +3,000</option>';
		$html[] = '<option value="'. Setting::B_season .'" '. $isSelectB .'>Bシーズン +5,000</option>';
		$html[] = '<option value="'. Setting::C_season .'" '. $isSelectC .'>Cシーズン +7,000</option>';
		$html[] = '</select>';
